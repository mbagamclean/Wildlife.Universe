...
// TODO: confirm final production domain. Setting NEXT_PUBLIC_SITE_URL
// will override this. Used as the metadataBase + canonical root.
export const SITE_URL = (
  process.env.NEXT_PUBLIC_SITE_URL || 'https://wildlife.universe'
).replace(/\/$/, '');
