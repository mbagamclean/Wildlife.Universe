...
const OPENING_PATTERN = /introduction|overview|\bintro\b|opening|the problem|the question|hook/i;
const CLOSING_PATTERN = /conclusion|summary|takeaway|final thoughts|closing|call to action/i;
const FAQ_PATTERN     = /frequently asked|\bfaq\b|\bfaqs\b|common questions/i;
...
export function validateGeneratedPost({ body, structured, coverUrl, category }) {
  ...
  // 3. Three structural anchors that every category's prompt emits
