...
// NOTE: this module is imported from both Next.js server components AND
// directly from Node CLI scripts (cron-batch / autopilot generate.mjs).
// Do not import any `@/` aliased modules here — Node CLI can't resolve
// them outside the Next bundler. Use a hardcoded canonical URL string
// for the one author website field that needs it. lib/seo.js mirrors the
// same canonical value, kept in sync manually.
const SITE_URL = 'https://www.wildlifeuniverse.org';
