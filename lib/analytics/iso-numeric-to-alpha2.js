/**
 * ISO 3166-1 numeric code → ISO 3166-1 alpha-2 code.
 *
 * The world-atlas TopoJSON uses M49 / ISO numeric codes (840, 826, …)
 * for the `id` property on each country feature. Vercel's
 * x-vercel-ip-country header emits alpha-2 (US, GB, …). The dashboard
 * choropleth needs to color paths from the topojson using counts
 * keyed by alpha-2 — this table bridges the two.
 */
export const ISO_NUMERIC_TO_ALPHA2 = {
  ...
  92: 'VG', 96: 'BN', 100: 'BG', 104: 'MM', 108: 'BI', 112: 'BY', 116: 'KH',
