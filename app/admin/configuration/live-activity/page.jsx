  ...
  return (
    <div className="p-5 sm:p-8">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-black sm:text-3xl" style={{ color: 'var(--adm-text)' }}>Live Activity</h1>
        <p className="mt-1 text-sm" style={{ color: 'var(--adm-text-muted)' }}>Monitor logged-in users, active admins, publishers, and page visitors in real time.</p>
      </div>
      <div
      ...
      >
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl" style={{ background: '#00800018' }}>
          <Activity className="h-7 w-7" style={{ color: '#008000' }} />
        </div>
        <h2 className="text-lg font-bold" style={{ color: 'var(--adm-text)' }}>Live Activity</h2>
        <p className="max-w-xs text-center text-sm" style={{ color: 'var(--adm-text-muted)' }}>Monitor logged-in users, active admins, publishers, and page visitors in real time.</p>
