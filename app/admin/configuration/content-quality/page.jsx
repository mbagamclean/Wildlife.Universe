  ...
  return (
    <div className="p-5 sm:p-8">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-black sm:text-3xl" style={{ color: 'var(--adm-text)' }}>Content Quality Checker</h1>
        <p className="mt-1 text-sm" style={{ color: 'var(--adm-text-muted)' }}>Analyse posts for quality, readability, and SEO.</p>
      </div>
      <div
      ...
      >
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl" style={{ background: '#00800018' }}>
          <CheckCircle2 className="h-7 w-7" style={{ color: '#008000' }} />
        </div>
        <h2 className="text-lg font-bold" style={{ color: 'var(--adm-text)' }}>Content Quality Checker</h2>
        <p className="max-w-xs text-center text-sm" style={{ color: 'var(--adm-text-muted)' }}>Analyse posts for quality, readability, and SEO.</p>
